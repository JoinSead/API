	    ...
	    case 'staging' :
	        ...
	        config.stripe = {
	            ...
	            publishable_key : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/staging/stripe_publishable_key.txt', 'utf8').trim(), 'base64', 'utf8'),
	           	magic_connect_code : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/staging/magic_connect_code.txt', 'utf8').trim(), 'base64', 'utf8'),
	        	magic_card_code : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/staging/magic_card_code.txt', 'utf8').trim(), 'base64', 'utf8'),
	        	magic_customer_id : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/staging/magic_customer_id.txt', 'utf8').trim(), 'base64', 'utf8')
	        };
	    ...
	    case 'production' :
	        ...
	        config.stripe = {
	            ...
	            publishable_key : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/production/stripe_publishable_key.txt', 'utf8').trim(), 'base64', 'utf8'),
	           	magic_connect_code : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/production/magic_connect_code.txt', 'utf8').trim(), 'base64', 'utf8'),
	        	magic_card_code : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/production/magic_card_code.txt', 'utf8').trim(), 'base64', 'utf8'),
	        	magic_customer_id : private_key.decrypt(fs.readFileSync('./devops/encrypted_files/production/magic_customer_id.txt', 'utf8').trim(), 'base64', 'utf8')
	        };
